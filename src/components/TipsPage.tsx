      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/30 mb-6">
            ...
            <span className="text-sm text-purple-300">The Complete Guide</span>
          </div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <Callout type="info" title="What you will learn">
                <ul className="space-y-2">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> The philosophy behind vibe coding and why it works</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> How to read code effectively and build strong mental models</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> A step-by-step workflow you can follow for any coding task</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> How to write effective AI prompts for coding assistance</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Debugging techniques that actually work</li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Security-first thinking for every line you write</li>
                </ul>
              </Callout>
              <DocParagraph>
          ...
          <section id="philosophy" className="scroll-mt-8">
            ...
            <div className="mt-6 space-y-6">
              ...
              <StepBlock step={2} title="Understanding beats memorization">
                ...
                When you understand the <em className="text-cyan-300">why</em>, the <em className="text-cyan-300">how</em> follows naturally.
              </StepBlock>
    ...
    # Happy path continues here...`}</CodeExample>
              ...
              <StepBlock step={4} title="Ask critical questions">
                ...
                <ul className="mt-3 space-y-1.5 text-gray-400">
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> What happens if this input is None or empty?</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Is there an edge case that is not handled?</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Could this fail silently instead of raising an error?</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Is there a performance concern with this approach?</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-cyan-400 mt-0.5 flex-shrink-0" /> Does this trust user input when it should not?</li>
                </ul>
              </StepBlock>
...
# result = [0, 4, 16]`}</CodeExample>
              ...
              <StepBlock step={3} title="Map concepts to analogies">
                ...
                <ul className="mt-3 space-y-2 text-gray-400">
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Stack</strong> — A stack of plates. Last one placed is first one removed.</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Queue</strong> — A line at a store. First in, first out.</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Hash map</strong> — A phone book. Look up a name, get a number instantly.</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Recursion</strong> — Russian nesting dolls. Each doll contains a smaller version of itself.</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">API</strong> — A waiter at a restaurant. Takes your order, brings back what you asked for.</li>
                </ul>
              </StepBlock>
            ...
            <div className="mt-6 space-y-6">
              ...
              <StepBlock step={1} title="Understand the problem">
                ...
                <Callout type="example" title="Example">
                  <strong className="text-white">Task:</strong> "Fix the login bug"<br/>
                  <strong className="text-white">Clarified:</strong> "Users with uppercase letters in their email
          ...
          <section id="daily" className="scroll-mt-8">
            ...
            <div className="mt-6 space-y-6">
              ...
              <StepBlock step={1} title="Read code from projects you admire">
                ...
                <ul className="mt-3 space-y-1.5 text-gray-400">
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Flask</strong> — Clean, readable Python web framework</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Redis</strong> — Elegant C code with excellent comments</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">React</strong> — Modern JavaScript patterns at scale</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">FastAPI</strong> — Modern Python with excellent type hints</li>
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" /> <strong className="text-white">Go standard library</strong> — Idiomatic, well-documented Go</li>
                </ul>
              </StepBlock>
...
function StepBlock({ step, title, children }: { step: number; title: string; children: React.ReactNode }) {
  return (
    <div className="relative pl-10">
      <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-purple-500/20 border border-purple-500/40 flex items-center justify-center">
        <span className="text-xs font-bold text-purple-300">{step}</span>
      </div>
...
function CodeExample({ children }: { children: string }) {
  return (
    <div className="mt-3 rounded-lg overflow-hidden border border-white/10" style={{ backgroundColor: '#282C34' }}>
...
function Callout({ type, title, children }: { type: 'info' | 'tip' | 'warning' | 'quote' | 'example'; title: string; children: React.ReactNode }) {
  const styles: Record<string, { border: string; bg: string; icon: React.ReactNode; titleColor: string }> = {
    info: { border: 'border-cyan-500/30', bg: 'bg-cyan-500/5', icon: <Lightbulb className="w-4 h-4 text-cyan-400" />, titleColor: 'text-cyan-400' },
    ...
    quote: { border: 'border-purple-500/30', bg: 'bg-purple-500/5', icon: <Sparkles className="w-4 h-4 text-purple-400" />, titleColor: 'text-purple-400' },
...
function TimeBlock({ time, title, color, children }: { time: string; title: string; color: string; children: React.ReactNode }) {
  const textColor: Record<string, string> = { cyan: 'text-cyan-400', purple: 'text-purple-400', green: 'text-green-400' };
  return (
...
function MistakeBlock({ title, number, children }: { title: string; number: number; children: React.ReactNode }) {
  return (
    <div className="glass-card rounded-xl border border-yellow-500/15 p-5">
